...
Seasoned transaction monitoring/compliance/risk analytics professional with **10+ years** of experience across EMEA & APAC markets. MSc in Voice Technology at University of Groningen 2025, combining deep financial expertise with cutting-edge AI/ML capabilities for FEC/AML risk management.

My unique blend of hands-on experience in structured finance, cross-border transactions, and emerging ML technologies positions me at the intersection of traditional risk management and innovative compliance solutions.
...
**Core Competencies:**
- **AML/FEC**: Transaction Monitoring, KYC/CDD, Sanctions Screening, Risk Assessment
- **Risk Analytics**: Basel II/III, IFRS 9, Stress Testing, Portfolio Surveillance
- **ML Applications**: Anomaly Detection (Isolation Forest, Autoencoders), NLP (FinBERT), Predictive Modeling
- **Regulatory Frameworks**: AMLD, EBA, DNB, Wwft, GDPR, EU AI Act

### Current Projects

- **[FEC-ML-Toolkit](https://github.com/tiantianzhang-dev/FEC-ML-Toolkit)** - Advanced ML algorithms for transaction monitoring and financial crime detection
- **[Credit-Risk-Analytics](https://github.com/tiantianzhang-dev/Credit-Risk-Analytics)** - IFRS 9 and Basel III compliant risk assessment models
